      ...
      <div className="cover-banner mt-16  md:hidden ini-hp">
        ...
        >
          <div className=" w-full text-center">
            ...
            <p className="text-secondary-2 text-[2rem] font-bold mt-[100px]">8 Years</p>
            <p className="text-secondary-2 text-[1rem] mt-1">Been trusted by customer</p>
            <p className="text-secondary-2 text-[2rem] font-bold mt-[100px]">20.000</p>
            <p className="text-secondary-2 text-[1rem] mt-1">Sold to our customer</p>
            <p className="text-secondary-2 text-[2rem] font-bold mt-[100px]">1000</p>
            <p className="text-secondary-2 text-[1rem] mt-1">Bottle sold / month</p>
          </div>
        </div>
      </div>
    </div>
