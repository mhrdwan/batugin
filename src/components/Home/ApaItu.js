      ...
      <div className="warpnya grid grid-cols-1 md:grid-cols-2 md:ml-[7.5rem] md:mr-[7.5rem] ">
        ...
        <div className=" md:mt-[5.6rem]  ">
          ...
          <div className="flex justify-center md:block">
            <button className="bg-accents-2 border text-[1.25rem] w-11/12 pl-6 pr-6 border-accents-2 text-white font-semibold text-base leading-normal md:w-[10rem] h-[3.75rem] px-2 py-2 mt-[2rem] hover:bg-accents-1 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
              Beli Produk
            </button>
          </div>
        </div>
